...
export const mockAuthors: Author[] = [
  {
    ...
    avatarUrl: '/authors/camila-montes.webp',
    location: 'Colombia',
...
export const mockCertifications: Certification[] = [
  {
    ...
    authorAvatarUrl: '/authors/camila-montes.webp',
    ...
    galleryUrls: [
      '/gallery/alunawa/01.webp',
      '/gallery/alunawa/02.webp',
      '/gallery/alunawa/03.webp',
      '/gallery/alunawa/04.webp',
      '/gallery/alunawa/05.webp',
    ],
    contact: {
