...
export function Footer() {
  return (
    <footer className="bg-pattern-aztec text-white">
      <div className="mx-auto max-w-[1320px] px-4 py-14 md:px-8 md:py-16">
        <div className="grid grid-cols-1 gap-10 md:grid-cols-12 md:gap-8">
          <div className="md:col-span-3">
            <Logo variant="light" layout="vertical" className="items-start text-left" />
          ...
          <div className="md:col-span-3">
            ...
            <ul className="mt-5 flex flex-col gap-3 text-sm text-neutral-300">
              <li>
          ...
          <div className="md:col-span-3">
            ...
            <div className="mt-5">
              <div className="relative">
                ...
                <Input
                  placeholder="Buscar"
                  className="h-11 rounded-full border-navy-300/40 bg-white pl-11 text-sm text-navy-500 placeholder:text-neutral-500 focus-visible:border-gold-500"
                />
              </div>
            </div>
          </div>
